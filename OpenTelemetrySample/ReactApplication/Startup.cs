    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            if (servicesLocation != null)
                checksBuilder.AddElasticsearch(servicesLocation.ElasticsearchUriHealthCheck, "Elasticsearch",
                    ...
                    .AddUrlGroup(new Uri(servicesLocation.JaegerUriHealthCheck), "Jaeger",
                        tags: new[] { HealthCheckTags.Infrastructure, HealthCheckTags.Monitoring })
                    .AddUrlGroup(new Uri(servicesLocation.WebApplication), "WebApplication",
                        tags: new[] { HealthCheckTags.Application, HealthCheckTags.Monitoring });


            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ReactApplication", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => 
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ReactApplication v1"));
